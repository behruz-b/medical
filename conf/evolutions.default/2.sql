...
INSERT INTO "Users" ("id","created_at","firstname","lastname", "phone", "role", "company_code", "login", "password")
 VALUES (8,'2021-01-12 15:32:22.196016','doctor','superuser','998994461230','doctor.role','all','doc','c7ef8fc860e6b06ce37526b3e361700d');
-- pass reg123
INSERT INTO "Users" ("id","created_at","firstname","lastname", "phone", "role", "company_code", "login", "password")
 VALUES (9,'2021-01-12 15:32:22.196016','register','superuser','998994461230','register.role','all','reg','5c769a1e38d1af34a22a4fdf3e334409');
-- pass admin123
INSERT INTO "Users" ("id","created_at","firstname","lastname", "phone", "role", "company_code", "login", "password")
 VALUES (10,'2021-01-12 15:32:22.196016','admin','superuser','998994461230','admin.role','all','admin','0192023a7bbd73250516f069df18b500');
